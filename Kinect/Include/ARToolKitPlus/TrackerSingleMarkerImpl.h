...
*
* $Id: TrackerSingleMarkerImpl.h 218 2007-06-06 08:55:46Z mendez $
* @file
* ======================================================================= */
...
public:
	...
	*/
	...
	size_t getMemoryUsage() const  {  return getMemoryRequirements();  }
...
#include "TrackerSingleMarkerImpl.ipp"
