...
public:
	...
	artkpFloat_fixed sqrt(const artkpFloat_fixed& nV)	{  return MATHBASE::sqrt(nV.v);  }
	...
	artkpFloat_fixed& operator-=(double nV)	{  v -= MATHBASE::fixedFromDouble(nV);  return *this;  }
	artkpFloat_fixed& operator*=(double nV)	{  v = MATHBASE::multiply(v, this->fixedFromDouble(nV));  return *this;  }
	artkpFloat_fixed& operator/=(double nV)	{  v = MATHBASE::divide(v, this->fixedFromDouble(nV));  return *this;  }
