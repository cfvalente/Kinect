...
*
* $Id: Tracker.h 181 2006-09-07 09:49:27Z daniel $
* @file
* ======================================================================== */
...
public:
	...
	*  track using the convex hull of the corner points of all visible markers of a
	*  multi-marker configuration. Two hull modes are available: HULL_FOUR which tracks
	*  using only four 'good' points or HULL_FULL which uses all corner points of the
	*  convex hull for for tracking.
	*  If the pose estimator is set to RPP then RPP will be used to track those points.
	*  Otherwise, ARToolKit's standard single-marker pose estimator will be used to
	*  track the pose of these points.
	*/
	...
	//virtual void convertTransformationMatrixToOpenGLStyle(ARFloat para[3][4], ARFloat gl_para[16]) = 0;
