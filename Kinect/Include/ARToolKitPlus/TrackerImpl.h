...
*
* $Id: TrackerImpl.h 210 2007-05-09 12:26:23Z bornik $
* @file
* ======================================================================== */
...
#ifndef _ARTKP_NO_MEMORYMANAGER_
	if(memManager)
		return (T*)memManager->getMemory(size_bytes);
	else
#endif //_ARTKP_NO_MEMORYMANAGER_
		return (T*)::malloc(size_bytes);
}
...
public:
	...
	*/
	...
	virtual size_t getMemoryUsage() const  {  return getDynamicMemoryRequirements();  }
...
#  include <ARToolKitPlus/extra/FixedPoint.h>
#  include <ARToolKitPlus/core/arBitFieldPattern.ipp>
#  include <ARToolKitPlus/core/arDetectMarker.ipp>
#  include <ARToolKitPlus/core/arDetectMarker2.ipp>
#  include <ARToolKitPlus/core/arGetCode.ipp>
#  include <ARToolKitPlus/core/arGetMarkerInfo.ipp>
#  include <ARToolKitPlus/core/arGetTransMat.ipp>
#  include <ARToolKitPlus/core/arGetTransMat2.ipp>
#  include <ARToolKitPlus/core/arGetTransMat3.ipp>
#  include <ARToolKitPlus/core/rppGetTransMat.ipp> // RPP integration -- [t.pintaric]
#  include <ARToolKitPlus/core/arGetTransMatCont.ipp>
#  include <ARToolKitPlus/core/arLabeling.ipp>
#  include <ARToolKitPlus/core/arMultiActivate.ipp>
#  include <ARToolKitPlus/core/arMultiGetTransMat.ipp>
#  include <ARToolKitPlus/core/rppMultiGetTransMat.ipp>  // RPP integration -- [t.pintaric]
#  include <ARToolKitPlus/core/arMultiReadConfigFile.ipp>
#  include <ARToolKitPlus/core/arUtil.ipp>
#  include <ARToolKitPlus/core/mPCA.ipp>
#  include <ARToolKitPlus/core/paraDecomp.ipp>
#  include <ARToolKitPlus/core/paraDistortion.ipp>
#  include <ARToolKitPlus/core/paraFile.ipp>
#  include <ARToolKitPlus/TrackerImpl.ipp>
#  include <ARToolKitPlus/librpp/arGetInitRot2.ipp>
#  include <ARToolKitPlus/core/arMultiGetTransMatHull.ipp>
