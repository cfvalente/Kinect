 ...
 *
 * $Id: arGetTransMat.ipp 210 2007-05-09 12:26:23Z bornik $
 * @file
 * ======================================================================== */
...
AR_TEMPL_TRACKER::arGetTransMat(ARMarkerInfo *marker_info, ARFloat center[2], ARFloat width, ARFloat conv[3][4])
{
	...
	//ARFloat  rot2[3][3];
	//arGetInitRot2( marker_info, arCamera->mat, rot2, center, width);
	...
	//for(i=0; i<4; i++)
	//	trackedCorners.push_back(CornerPoint((int)ppos2d[i][0],(int)ppos2d[i][0]));
