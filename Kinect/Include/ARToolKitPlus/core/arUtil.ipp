 ...
 *
 * $Id: arUtil.ipp 210 2007-05-09 12:26:23Z bornik $
 * @file
 * ======================================================================== */
...
AR_TEMPL_TRACKER::arInitCparam(Camera *pCam)
{
	...
	//
	if(undistO2ITable!=NULL && (arImXsize!=pCam->xsize || arImYsize!=pCam->ysize))
	{
...
{
#ifdef WIN32
  PROFILE_BEGINSEC(profiler, GETLINE)
#endif

    //return arGetLine2( x_coord, y_coord, coord_num, vertex, line, v, arParam.dist_factor );
    int ret = arGetLine2( x_coord, y_coord, coord_num, vertex, line, v, arCamera );

#ifdef WIN32
  PROFILE_ENDSEC(profiler, GETLINE)
#endif
