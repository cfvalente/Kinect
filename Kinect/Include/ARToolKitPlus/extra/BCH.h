...
*
* $Id: BCH.h 210 2007-05-09 12:26:23Z bornik $
* @file
* ======================================================================== */
...
bool _isBitSet(_64bits bn, int which_bit);
void _setBit(_64bits &bn, int which_bit);
/*
void _clearBit(_64bits &bn, int which_bit);
void _copyBit(_64bits &dest_n, const int dest_bit, const _64bits src_n, const int src_bit);
int _countOnes(const _64bits src_n);
*/

int* toBitPattern(int b[], _64bits n, int n_bits);
_64bits fromBitPattern(int b[], int n_bits);
