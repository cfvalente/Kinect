...
inline long imul(long x, long y, long BITS)
{
	return ((I32) (((I64)x * (I64)y) >> BITS));
}
#endif
...
inline void FIXED_VEC3_DOT(FIXED_VEC3D* vec1, FIXED_VEC3D* vec2, I32* res, I32 n)
{
	*res = (I32)(((I64)vec1->x*(I64)vec2->x + (I64)vec1->y*(I64)vec2->y + (I64)vec1->z*(I64)vec2->z) >> n);
}
...
inline void FIXED_VEC2_SUB(FIXED_VEC3D* vec1, FIXED_VEC3D* vec2, FIXED_VEC3D* res)
{
	res->x = vec1->x - vec2->x;
	res->y = vec1->y - vec2->y;
}
...
inline void FIXED_VEC3_LENGTH_SQ(FIXED_VEC3D* vec, U32* res, I32 n)
{
	*res = (I32)(((I64)vec->x*(I64)vec->x + (I64)vec->y*(I64)vec->y + (I64)vec->z*(I64)vec->z) >> n);
}

inline void FIXED_VEC2_LENGTH_SQ(FIXED_VEC3D* vec, U32* res, I32 n)
{
	*res = (I32)(((I64)vec->x*(I64)vec->x + (I64)vec->y*(I64)vec->y) >> n);
}
