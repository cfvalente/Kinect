...
*
* $Id: Profiler.h 198 2006-11-01 16:00:04Z daniel $
* @file
* ======================================================================== */
...
public:
	...
	Measurement _SINGLEMARKER_OVERALL, _LABELING, _DETECTMARKER2, _GETMARKERINFO, _GETLINE, _MATRIXPCA, _GETCODE,
				_GETTRANSMAT, _GETINITROT, _GETTRANSMAT3, _GETTRANSMATSUB, _MODIFYMATRIX_LOOP, _MODIFYMATRIX, _GETNEWMATRIX,
				_GETROT, _GETANGLE;
...
#else
  #define PROFILE_BEGINSEC(obj, mes);		{  obj;  }
  #define PROFILE_ENDSEC(obj, mes);			{  obj;  }

  #define PROFILEPTR_BEGINSEC(obj, mes)		{  obj;  }
  #define PROFILEPTR_ENDSEC(obj, mes)		{  obj;  }
